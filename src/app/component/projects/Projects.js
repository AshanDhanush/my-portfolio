        ...
        <section id="projects" className="min-h-screen w-full py-28 px-6 relative">
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {/* Project 3: HealthSync (Hospital Management System) */}
                    <motion.div 
                        initial={{ opacity: 0, y: 40 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: "-100px" }}
                        whileHover={{ y: -12, borderTopColor: "rgba(34, 211, 238, 0.4)" }}
                        transition={{ duration: 0.4, ease: "easeOut" }}
                        className="flex flex-col bg-slate-900/40 border border-white/5 backdrop-blur-xl rounded-2xl p-6 transition-all duration-300 hover:shadow-[0_15px_40px_rgba(34,211,238,0.08)] group md:col-span-2 lg:col-span-1"
                    >
                        <div className="flex items-center justify-between mb-3">
                        ...
                        {/* Placeholder for project image background grid */}
                        <div className="relative w-full h-48 mb-5 overflow-hidden rounded-xl border border-white/10 bg-slate-950 flex items-center justify-center">
                            <div className="absolute inset-0 bg-[radial-gradient(#1e293b_1px,transparent_1px)] [background-size:16px_16px] opacity-30" />
                            <span className="text-slate-600 font-mono text-xs z-10">UI/UX Showcase</span>
                        </div>
                        <p className="text-slate-400 text-sm leading-relaxed font-sans mb-6 flex-grow">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                            ...
                            <a href="#" className="text-slate-400 hover:text-cyan-400 transition-all transform hover:scale-110">
                                <GitHubIcon />
                            </a>
                        </div>
                    </motion.div>
